  ...
  return (
    <div class="min-h-screen flex items-center justify-center bg-gray-50">
      <div class="bg-white p-8 rounded-2xl shadow w-full max-w-sm">
        <h1 class="text-2xl font-semibold text-gray-800 mb-2 text-center">Rappi Ecosystem</h1>
        <p class="text-sm text-gray-400 text-center mb-6">Sign in to your account</p>
        ...
        <p class="text-sm text-gray-500 text-center mt-4">
          ...
          <Link to="/register" class="text-purple-600 hover:underline">Register</Link>
        </p>
      </div>
    </div>
  );
